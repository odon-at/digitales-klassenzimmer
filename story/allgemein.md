...
1. **Schatten-Archiv** – die ersten Fragmente bergen und säubern.
2. **Cyber-Tauben** – Nachrichten am gekaperten Netz vorbeischmuggeln (API).
...
- **Akzentfarben (Kanon):**
  ...
  | Login | Cyan |
  | Avatar Lyra / Ben / Zen | Pink / Gelb / Grün |
  | Level 1 / 2 / 3 / 4 | Grün / Violett / Gelb / Grün |
...
- **Punkte:** je Level max. **100**, gesamt **400**. Abzüge bei Fehlversuchen/Tipps (mit Untergrenze).
- **Ränge** (nach Gesamtpunkten): **S** ≥ 360 · **A** ≥ 280 · **B** ≥ 200 · sonst **C**.
