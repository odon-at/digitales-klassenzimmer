...
flowchart LR
  ...
  D --> E[Missionskarte]
  E --> L1["Level 1<br/>Schatten-Archiv"]
  E --> L2["Level 2<br/>Cyber-Tauben"]
...
| 7 | Belohnung / Zertifikat | [belohnung.md](belohnung.md) | *(nur PDF)* | `images/screens/belohnung.png` |
...
Weitere Schlüssel: `nexusdata.hall` (Bestenliste) · `nexusdata.muted` (Ton an/aus).

Abgeleitete Werte: **Schlüssel** = Anzahl `completed`; **Gesamtpunkte** = Summe `scores`;
**Rang** = aus Gesamtpunkten (siehe [allgemein.md](allgemein.md) §7).

## 4. Wiederkehrende UI-Bausteine

- **HUD** (oben, ab Missionskarte): Avatar-Chip, `🔑 X/4`, `⚡ Punkte`.
...
- **Ton-Schalter** (🔊/🔇, immer oben rechts).
