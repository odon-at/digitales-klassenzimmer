...
**Ein Vorlese-Knopf (ab v0.10.0):** Alle drei Avatar-Varianten teilen sich **einen**
Knopf „🔊 Vorlesen"; auch Lennox' Funk-Kanal nutzt ihn (geblieben ist dort nur
„Transkript gelesen ✓" als tonloser Weg zur Bonusfrage). **Nichts startet von
selbst.** Ob eine Aufnahme oder die Browser-Stimme spricht, entscheidet die Tabelle
in `game/js/data/voice.js` – siehe [stimme.md](stimme.md).

**Glossar:** Das Begriffs-Glossar zu Level 1 steht **nicht** im Info-Fenster, sondern
im Ergebnis-Bildschirm des Levels neben Maschinen- und Menschen-Ansicht
(siehe [levels/level-1-cyber-tauben.md](levels/level-1-cyber-tauben.md)).

**Sprachausgabe (v0.9.0, seither vereinheitlicht):** Jeder Tipp, jede Info und jede Seite des
