...
- **Ton-Schalter** (🔊/🔇, immer oben rechts) – schaltet Effekte, Sprachausgabe
  **und** die Aufnahme der Bürger-KI gemeinsam stumm.
...
- **Sprachausgabe** (ab v0.9.0): Tipps und Info-Texte lassen sich vorlesen; die
  Bürger-KI hat eine eigene Aufnahme (`game/media/buerger-ki-stimme.mp3`), siehe
  [audio/stimme.md](audio/stimme.md).
