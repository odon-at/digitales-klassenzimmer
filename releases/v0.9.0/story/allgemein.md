...
- Ton ist optional und stummschaltbar (🔊/🔇), nichts ist rein auf Audio angewiesen.
  Umgekehrt gilt seit v0.9.0 auch: nichts hängt allein am Lesen – Tipps und
  Info-Texte lassen sich **vorlesen**, und die Bürger-KI hat eine eigene Stimme
  (siehe [audio/stimme.md](audio/stimme.md)). Fällt die Sprachausgabe aus, bleibt
  der Text sichtbar.
