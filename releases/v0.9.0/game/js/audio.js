/* =========================================================================
   ...
   Drei Tonquellen, ein gemeinsamer Mute-Schalter:
     ...
     clip.play()   – feste Aufnahme aus game/media/ (Erkennungsstimme)
   voice und clip schließen sich gegenseitig aus – zwei Stimmen gleichzeitig
   versteht niemand.
   ========================================================================= */
window.NX = window.NX || {};
(function (NX) {
  ...
  clip = (function () {
    var CLIPS = { kiVoice: 'media/buerger-ki-stimme.mp3' };
    var els = {};       // name -> <audio>
    ...
    function known(name) { return Object.prototype.hasOwnProperty.call(CLIPS, name); }
    ...
    function get(name) {
      ...
      var a;
      try { a = new window.Audio(CLIPS[name]); } catch (e) { broken[name] = true; return null; }
      // 207 KB erst holen, wenn wirklich jemand auf Abspielen drückt
