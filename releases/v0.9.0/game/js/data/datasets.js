...
(function (NX) {
  ...
  var level1 = {
    ...
    /* Statuszeile im Ausrüstungs-Hangar. Kein Start-Intro mehr (Spec:
       „Wichtige Verbesserung zu Beginn des Level 1") – die Taube wird Schritt
       für Schritt ausgerüstet und fliegt erst auf Knopfdruck los. */
    hangar: {
      step0: 'Bereit zur Ausrüstung · wähle zuerst die Ziel-Adresse.',
      step1: 'Adresse gespeichert · jetzt den Handlungs-Befehl wählen.',
      step2: 'Befehl gesetzt · jetzt den Passierschein in den Schnabel laden.',
      ready: '✓ Voll ausgerüstet – die Taube kann losfliegen!'
    },
    ...
    banner: {
      ...
      step3: 'Aufgabe 3: Wähle im Token-Speicher (3) einen gültigen Passierschein und drücke dann [ TAUBE LOSSCHICKEN! ].',
  ...
  var level4 = {
    ...
    banner: {
      ...
      step2: 'Ziehe den Chip „{chip}“ ins leuchtende Feld oder klicke ihn an!',
    ...
    city: {
      ...
      answers: [
        { id: 'open', key: 'f', icon: '✓', label: 'FREIGEBEN', color: '#21a75b' },
        { id: 'block', key: 's', icon: '✖', label: 'SPERREN', color: '#1c62d6' }
      ],
      finale: {
