  ...
  NX.levelDefs.push({
    ...
    mount: function (container, ctx) {
      ...
      function renderTerminal() {
        ...
        // Token-Speicher: füllt sich, sobald der Passierschein gewählt ist
        ...
        /* Ausrüstungs-Hangar rechts: Taube steht von Beginn an bereit; die
           Pergamentrolle gleitet erst beim Token-Schritt in den Schnabel. */
        ...
        station = el('div', { class: 'ct-station' }, [
          el('div', { class: 'ct-hangar-title', text: 'AUSRÜSTUNGS-HANGAR' }),
