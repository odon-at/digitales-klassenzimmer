...
(function (NX) {
  ...
  /* ---- Level 1: Trinkbrunnen-Datensatz mit unmöglichen TEMPERATUR-Werten ----
     Der wahre Messwert (trueTemp) wird durch Antippen des jeweiligen Brunnens enthüllt.
     Zwei Zeilen enthalten unmögliche Temperaturen (2000 °C bzw. -300 °C, unter 0 Kelvin). */
  var level1 = {
    columns: ['ID', 'Bezirk', 'pH-Wert', 'Temperatur °C', 'Status'],
    rows: [
      { id: 'BR-01', bezirk: 'Zentrum',   theme: 'Futuristischer High-Tech-Brunnen',        icon: '🏙️', fc: '#35e6ff', ph: '7.2', temp: '2000.0', trueTemp: 11.4, bad: true },
      { id: 'BR-02', bezirk: 'Hafen',     theme: 'Maritimer Industriepumpen-Brunnen',       icon: '⚓', fc: '#3a86ff', ph: '7.5', temp: '12.1', trueTemp: 12.1, bad: false },
      { id: 'BR-03', bezirk: 'Altstadt',  theme: 'Historischer Steinbrunnen mit Neon-Adern', icon: '🏛️', fc: '#ffb03a', ph: '6.9', temp: '-300.0', trueTemp: 10.8, bad: true },
      { id: 'BR-04', bezirk: 'Nordpark',  theme: 'Organischer Brunnen mit Neon-Pflanzen',   icon: '🌿', fc: '#39ff88', ph: '7.0', temp: '11.0', trueTemp: 11.0, bad: false },
      { id: 'BR-05', bezirk: 'Industrie', theme: 'Mechanischer Mess-Brunnen mit Zahnrädern', icon: '⚙️', fc: '#ff7a1a', ph: '7.1', temp: '12.6', trueTemp: 12.6, bad: false }
    ],
    tempHardRange: { min: -50, max: 60 }, // plausible Wasser-Temperatur (für Fehlermeldung)
    tolerance: 0.6,                        // erlaubte Abweichung vom wahren Messwert
    quality: 80
  };
