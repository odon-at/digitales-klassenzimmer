...
**„Über uns"-Fenster** über der Startseite (Overlay `#aboutscreen`, seit v0.13.0)
→ [startseite.md](startseite.md).
...
- **Sprachausgabe** (ab v0.12.0): Tipps, Hilfe- und Info-Texte haben **einen**
  Vorlese-Knopf, der nur auf Knopfdruck startet und **immer die Browser-Stimme**
  nutzt – siehe [stimme.md](stimme.md). Einzige feste Aufnahme: die **Einleitung**
