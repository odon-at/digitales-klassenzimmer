...
> **Überholt.** Die gültige Beschreibung steht in [../stimme.md](../stimme.md):
> Der VORLESEN-Knopf nutzt seit v0.12.0 **ausnahmslos die Browser-Stimme**. Die hier
> beschriebene Aufnahme vertont die **Einleitung** (siehe ../einleitung.md) und liegt
> als `game/media/einleitung.mp3`. Der Abschnitt unten beschreibt den Stand von
> v0.9.0.

## ✅ Umsetzung v0.9.0 (überholt)
