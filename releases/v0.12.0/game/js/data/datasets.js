  ...
  var level1 = {
    ...
    help: {
      url: {
        ...
        html: '<p>Eine <b>URL</b> ist wie die Postadresse eines Servers. Damit die Cyber-Taube ' +
              'weiß, wo genau sie die offenen Daten abholen soll, muss die korrekte Zieladresse ' +
              'ausgewählt werden.</p>'
      },
      method: {
    ...
    city: {
      intro: {
        ...
        text: 'Das Bürger-Portal läuft. Jetzt geh hinaus und prüfe, welche Daten in der ' +
              ...
              'Drehe dich mit der Maus – ziehen oder die Pfeil-Knöpfe am Rand anklicken – ' +
              'um 360° und klicke die leuchtenden Punkte an.',
        cta: '🌍 STADT BETRETEN'
      },
