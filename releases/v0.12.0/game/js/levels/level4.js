  ...
  NX.levelDefs.push({
    ...
    mount: function (container, ctx) {
      ...
      function askChart(i) {
        ...
        function onTypePick(t, btn) {
          ...
          if (t.id === c.typ) {
            ...
            armSlot(t.id);
            chip.disabled = false;
            setBanner(d.banner.step2.replace('{chip}', c.chip), '🖐️');
      ...
      function enterCity() {
        ...
        announce('360°-Stadt. Mit der Maus ziehen oder die Pfeil-Knöpfe am Rand anklicken, um dich zu ' +
          'drehen; Tabulator springt von Hotspot zu Hotspot. 10 Szenarien zu prüfen.');
