  ...
  NX.levelDefs.push({
    ...
    mount: function (container, ctx) {
      ...
      function enterCity() {
        ...
        /* In der 360°-Ansicht drehen AUSSCHLIESSLICH die Pfeiltasten (Spec:
           „Andere Tastenbefehle zur direkten Menü- oder Objektanwahl sind in
           dieser Ansicht deaktiviert"). Tabulator und Enter bleiben – das ist
           der normale Browser-Weg und der einzige Zugang ohne Maus. */
        setKeyHandler(function (e) {
          if (!lb.alive) return;
          var modal = document.getElementById('modal');
          if (modal && !modal.hidden) return;
