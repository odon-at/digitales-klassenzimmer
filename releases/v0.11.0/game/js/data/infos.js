...
(function (NX) {
  ...
  infos[1] = {
    ...
    lyra: {
      ...
      caption: 'Tippe immer den hervorgehobenen Knoten an – der Weg der Anfrage baut sich Schritt für Schritt auf.',
      nodes: [
        ...
        { id: 'req',  x: 34, y: 12, icon: '📨', label: 'Anfrage', color: '#00f3ff',
          text: 'Drei Teile: Adresse (Endpoint) + Auftrag (Methode) + Zugangsschlüssel (Token).' },
        { id: 'api',  x: 52, y: 31, icon: '🔌', label: 'API', color: '#b25cff',
          text: 'Die Übergabestelle. Sie nimmt die Anfrage an und prüft den Zugangsschlüssel.' },
    ...
    lennox: {
      ...
      script: [
        ...
        { who: 'LENNOX', text: 'Der Ausweis ist der API-Token, ein digitaler Zugangsschlüssel. Ohne gültigen Schlüssel: kein Zutritt.' },
      ...
      bonus: {
        ...
        options: [
          ...
          { id: 'b', label: 'Der API-Token – der Zugangsschlüssel' },
          { id: 'c', label: 'Das JSON – die Antwort' }
        ],
        answer: 'b',
        okText: 'Sauber zugehört! Der Token ist der Zugangsschlüssel.',
      ...
      pages: [
        [ { k: 'h',  v: 'API — Definition' },
          ...
          { k: 'ul', v: ['Endpoint = genaue Zieladresse (URL)',
                         ...
                         'Token    = digitaler Zugangsschlüssel'] } ],
        [ { k: 'h',    v: 'JSON — Aufbau' },
          { k: 'code', v: '{\n  "buch": {\n    "titel": "Datenkunde",\n    "seiten": 128\n  }\n}' },
  ...
  infos[2] = {
    ...
    lyra: {
      ...
      caption: 'Tippe immer den hervorgehobenen Knoten an – Schritt für Schritt schließt sich der Kreis.',
      nodes: [
  ...
  infos[3] = {
    ...
    lyra: {
      ...
      caption: 'Tippe immer den hervorgehobenen Knoten an – die vier Module führen zum Urteil.',
      nodes: [
  ...
  infos[4] = {
    ...
    lyra: {
      ...
      caption: 'Tippe immer den hervorgehobenen Knoten an – so entsteht Schritt für Schritt aus Daten Wissen.',
      nodes: [
