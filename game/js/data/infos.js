...
(function (NX) {
    ...
    lyra: {
      ...
      bonus: {
        ...
        options: [
          ...
          { id: 'c', icon: '📊', label: 'Ein Balkendiagramm' },
  ...
  infos[4] = {
    ...
    bonusPoints: 15,
    forbidden: ['Industrie', 'Nordpark', 'PM10'],
    ...
    lyra: {
      ...
      nodes: [
        ...
        { id: 'viz', x: 40, y: 14, icon: '📊', label: 'Diagramm', color: '#ff2fb0',
          text: 'Balken vergleichen, Linien zeigen Verläufe, Torten zeigen Anteile.' },
      ...
      bonus: {
        prompt: 'Klicke das Diagramm, mit dem man Werte mehrerer Bezirke am besten vergleicht.',
        options: [
          { id: 'a', icon: '📊', label: 'Balkendiagramm' },
          { id: 'b', icon: '🥧', label: 'Tortendiagramm' },
          { id: 'c', icon: '🌡️', label: 'Einzelne Zahl' }
        ],
        answer: 'a',
        okText: 'Genau – Balken nebeneinander machen Größenunterschiede sofort sichtbar.',
        failText: 'Torten zeigen Anteile an einem Ganzen, eine Einzelzahl vergleicht gar nichts. Für Vergleiche nimmt man Balken.'
      }
    },
    ...
    lennox: {
      ...
      script: [
        ...
        { who: 'LENNOX', text: 'Ein Balkendiagramm vergleicht Werte. Eine Linie zeigt, wie sich etwas über die Zeit entwickelt.' },
        { who: 'LENNOX', text: 'Eine Torte zeigt Anteile an einem Ganzen – aber nur, wenn es wirklich ein Ganzes gibt.' },
    ...
    zen: {
      ...
      pages: [
        [ { k: 'h',  v: 'Diagrammarten' },
          { k: 'kv', v: [['Balken', 'Werte vergleichen (mehrere Kategorien)'],
                         ['Linie', 'Verlauf über die Zeit'],
                         ['Torte', 'Anteile an einem Ganzen (max. ~5 Teile)']] },
      ...
      bonus: {
        ...
        failText: 'Eine Torte zeigt Anteile, eine Einzelzahl keinen Verlauf. Zeitreihen gehören auf eine Linie.'
      }
    }
  };
